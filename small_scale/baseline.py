...
def run_baseline_gcn(args, seed):
    ...
    net_gcn = net.net_gcn_baseline(args['embedding_dim'][0], args['embedding_dim'][1], args['embedding_dim'][2], g)
    ...
    for epoch in range(args['epochs']):
        ...
        print("Epoch:[{}] LOSS:[{:.2f}] Val:[{:.2f}] Test:[{:.2f}] | Final Val:[{:.2f}] Test:[{:.2f}] at Epoch:[{}]".format(
                epoch, loss,
                acc_val * 100,
                acc_test * 100,
