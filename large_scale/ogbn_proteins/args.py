...
class ArgsInit(object):
    def __init__(self):
        ...
        parser.add_argument('--iteration', type=int, default=10, help='iteration for each subgraph')
        ...
        parser.add_argument('--mask_epochs', type=int, default=1000,
                            help='number of epochs to train (default: 100)')
        parser.add_argument('--fix_epochs', type=int, default=1000,
                            help='number of epochs to train (default: 100)')
        ...
        parser.add_argument('--save', type=str, default='CKPT', help='experiment name')
